...
<?php include 'models/qc-post-doc-model.php' ?>
        ...
        <!-- ---------- loader end here---------------------- -->
            ...
            <!-- ============================================================== -->
            <!-- <form class="form-horizontal" id="qcPostDocumentForm_open_transAllData" method="post"> -->
...
<script type="text/javascript">
    ...
    function QC_StatusByAnalystDropdown(trcount){
        ...
        $.ajax({
            ...
            success: function(result)
            {
                // console.log('QC_StatusByAnalystDropdown=> ',JSON.parse(result));
                var JSONObject = JSON.parse(result);
...
function GetSelectedInstumentdata(un_id) {
    ...
    // function SetComparisonResultValTOResOutput(un_id){
    //     var ComparisonResult = $('#ComparisonResult'+un_id).val();
    //     var UOM = $('#UOM'+un_id).val();

    //     if(ComparisonResult==''){
    //         $('#ComparisonResult'+un_id).val('');
    //         $('#ResultOut'+un_id).val('');
    //     }else{
    //         $('#ComparisonResult'+un_id).val(ComparisonResult);
    //         $('#ResultOut'+un_id).val(ComparisonResult+' '+UOM);
    //     }
    // }
</script>