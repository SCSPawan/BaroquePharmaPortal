...
if(isset($_REQUEST['action']) && $_REQUEST['action'] =='list'){
    ...
    $tdata['ToDate']=date('Ymd', strtotime($_POselectedRecordST['toDate']));
...
<?php include 'models/qc_post_document_kri_modal.php' ?>
    ...
    <style type="text/css">
        ...
        .border_hide{border: 1px solid #efefef !important;}
    </style>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Qc Post Document</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                        <li class="breadcrumb-item active">Qc Post Document</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header justify-content-between d-flex align-items-center">
                    <h4 class="card-title mb-0">Qc Post Document</h4>  
                </div>
    ...
    <div class="row" id="footerProcess">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form role="form" class="form-horizontal" id="qcPostDocumentForm" method="post" enctype="multipart/form-data">
                        <input type="hidden" id="U_DocEntry" name="U_DocEntry">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-lg-6">
                                        <!-- <select type= class="form-select" id="qcD_Series" name="qcD_Series"> -->
                                                        <!-- <option>Primary</option> -->
                                        <!-- </select> -->
                                         <input class="form-control" type="text" id="qcD_Series" name="qcD_Series" readonly>

                                          <input class="form-control" type="hidden" id="DocNo" name="DocNo" readonly>
                                    </div>
                                    <div class="col-lg-2">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group row mb-2">
                                   <label class="col-lg-4 col-form-label mt-6" for="val-skill">Location</label>
                                    <div class="col-lg-8">
                                        <input class="form-control desabled" type="text" id="qcD_Location" name="qcD_Location" readonly="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group row mb-2">
                                   <label class="col-lg-5 col-form-label mt-6" for="val-skill">Type of Material</label>
                                    <div class="col-lg-7">
                                        <input class="form-control desabled" type="text" id="qcD_TypeofMaterial" name="qcD_TypeofMaterial" readonly="">
                                    </div>
                                </div>
                            </div>
...
<div class="col-xl-3 col-md-6">
    <div class="form-group row mb-2">
       <label class="col-lg-4 col-form-label mt-6" for="val-skill">Release Date</label>
        <div class="col-lg-8">
            <input class="form-control desabled" type="text" id="ReleaseDate" name="ReleaseDate" readonly>
        </div>
    </div>
</div>
...
<div class="col-xl-3 col-md-6">
    <div class="form-group row mb-2">
       <label class="col-lg-4 col-form-label mt-6" for="val-skill">Retest Date</label>
        <div class="col-lg-8">
            <input class="form-control desabled" type="text" id="RetestDate" name="RetestDate" readonly>
        </div>
    </div>
</div>
                                        ...
                                        <div class="tab-content p-3 text-muted">
                                            ...
                                            <div class="tab-pane" id="attatchment3" role="tabpanel">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="gap-2">
                                                        <!-- <form action="#" method="post" id="mform" enctype="multipart/form-data"> -->
                                                              <label class="btn btn-primary active  mb-2">
                                                            Browse <input type="file" name="uploadFile" id="upload-File" hidden>
                                                            </label>
                                                        <!-- </form> -->
                                                            <!-- <label class="btn btn-primary active  mb-2">Browse <input type="file" name="attached_file" hidden></label> -->
                                                            <!-- <br>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3 col-md-6">
                                                        <div class="form-group row mb-2">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input class="form-control" type="number" id="AssayPotency_xyz" name="AssayPotency_xyz" onfocusout="CalculatePotency();" value="0.000000">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-3 col-md-6">
                                                        <div class="form-group row mb-2">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input class="form-control" type="number" id="LoD_Water_xyz" name="LoD_Water_xyz" onfocusout="CalculatePotency();" value="0.000000">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="d-flex flex-wrap gap-2">
                                                        ...
                                                        <button type="button" class="btn btn-primary" id="addQcPostDocumentBtn" name="addQcPostDocumentBtn" onclick="return add_qc_post_document();">Update</button>
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".qc_post_inventory_transfer" data-bs-toggle="button" autocomplete="off" onclick="qcPostDocumentnventoryTransfer();">Inventory Transfer</button>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                                                            ...
                                                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target=".QC_PostDocPrintLayout" autocomplete="off" onclick="ViewRPT_Print_Open('INWARDQCREJLABEL','Rejected Label Print')">Rejected Label Print</a></li>
...
<script type="text/javascript">
    ...
    function selectedRecord(DocEntry){
        var dataString ='DocEntry='+DocEntry+'&action=qc_post_document_ajax';
        ...
        $.ajax({  
            ...
            success: function(result){  
                ...
                // <!-- ----------------- Bottom Hidden Field start here ----------------------- -->
                    $(`#U_DocEntry`).val(JSONObject[0]['DocEntry']);
                ...
                $('#potency_xyz').val(parseFloat(JSONObject[0]['Potency']).toFixed(6));
                $('#noOfCont1').val(JSONObject[0]['NoCont1']);
                $('#noOfCont2').val(JSONObject[0]['NoCont2']);
                $('#AssayPotency_xyz').val(parseFloat(JSONObject[0]['APot']).toFixed(6));
                $('#LoD_Water_xyz').val(parseFloat(JSONObject[0]['LODWater']).toFixed(6));
         

                $('#qcD_Location').val(JSONObject[0]['Loc']);
                $('#qcD_MakeBy').val(JSONObject[0]['MakeBy']);
                $('#qcD_TypeofMaterial').val(JSONObject[0]['TypeofMaterial']);

                $('#qc_remarks').val(JSONObject[0]['Remarks']);
                ...
                // <!-- ----------- Release Date Start Here ----------------------- -->
                    var ReleaseDateOG = JSONObject[0]['ReleaseDate'];
                    if(ReleaseDateOG!=''){
                        ReleaseDate = ReleaseDateOG.split(' ')[0];
                        $(`#ReleaseDate`).val(ReleaseDate);
                    }
                // <!-- ----------- Release Date End Here ------------------------- -->

                // <!-- ----------- Retest Date Start Here ----------------------- -->
                    var RetestDateDateOG = JSONObject[0]['RetestDate'];
                    if(RetestDateDateOG!=''){
                        RetestDateDate = RetestDateDateOG.split(' ')[0];
                        $(`#RetestDate`).val(RetestDateDate);
                    }
                ...
                // <!-- ----------- Expiry Date Start Here ----------------------- -->
                    ...
                    if(ExpiryDateOG!=''){
                        ...
                        $(`#qcD_ExpiryDate`).val(ExpiryDate);
                    }
                // <!-- ----------- Expiry Date End Here ------------------------- -->

                // Release Material Without QC Start here --------------------------
                    var dropdown = document.getElementById("RelMaterialWithoutQC");
                    dropdown.value = JSONObject[0]['ReleaseMatWithoutQC'];                
                // Release Material Without QC End here ----------------------------
                ...
                GetBottomApprovedBy(JSONObject[0]['SamBy']); // Get Bottom level Approved By and Done By Dropdown.
                // tablayoutvalidation();
            },
            complete:function(data){
                // $(".loader123").hide();
...
function QC_StatusByAnalystDropdownWithSelectedOption(trcount) {
    ...
    function add_qc_post_document(){
        ...
        formData.append("addQcPostDocumentBtn",'addQcPostDocumentBtn');  // Button Id
        var error = true;
...
//     $('#qCStsQty_'+un_id).val($('#qcD_BatchQty').val()); //QC Startus Tab AUto fatch document batch size to row level Qty
...
function GetSelectedInstumentdata(un_id) {
   ...
   /* function CalculateResultOut(un_id){
    ...
    function qcPostDocumentnventoryTransfer(){
        ...
        var qcD_DocEntry=document.getElementById('U_DocEntry').value;

        var AssayPotency= $(`#AssayPotency_xyz`).val();
        var LoD_Water= $(`#LoD_Water_xyz`).val();
        var potency= $(`#potency_xyz`).val();
        var assay_append= $(`#assay-append`).val();
        var factor= $(`#factor`).val();
        var ARNo= $(`#qcD_ARNo`).val();
        var RetestDate= $(`#RetestDate`).val();

        $.ajax({
            type: "POST",
            url: 'ajax/kri_common-ajax.php',
            data:{'QCstatus':QCstatus,'DocEntry':qcD_DocEntry,'action':"qc_post_document_pupup_ajax"},
            cache: false,
            dataType:'JSON',
            beforeSend: function(){
                $(".loader123").show();
            ...
            success: function(result){
                ...
                $('#tb_quality').val(qCStsQty); // New
                $('#from_whs').val(result[0].FromWhse);
                $('#to_whs').val(result[0].ToWhse);
                $('#tb_location').val(result[0].Loc);
                $('#BranchId').val(result[0].BPLID);
                $('#BatchNo_value').val(result[0].BatchNo);
                $('#_DocEntry').val(result[0].DocEntry);

                // <!-- --------- custome field start ----------------- -->
                    $('#QC_IT_AssayPotency').val(AssayPotency);
                    $('#QC_IT_LoD_Water').val(LoD_Water);
                    $('#QC_IT_potency').val(potency);
                    $('#QC_IT_assay_append').val(assay_append);
                    $('#QC_IT_factor').val(factor);
                    $('#QC_IT_ARNo').val(ARNo);
                    $('#QC_IT_RetestDate').val(RetestDate);
                // <!-- --------- custome field end ----------------- -->
    ...
    function getSeriesDropdown(){
        var TrDate=$('#qcD_PostingDate').val();
    ...
    function ContainerSelection(){
        var BatchNo=document.getElementById('BatchNo_value').value;
        var ItemCode=document.getElementById('tb_itme_code').value;
        var FromWhs=document.getElementById('from_whs').value;
        var ToWhse=document.getElementById('to_whs').value;

        var dataString ='ItemCode='+ItemCode+'&WareHouse='+FromWhs+'&BatchNo='+BatchNo+'&action=getInventorycotainerSelection_ajax';
                ...
                if(PostingDate!=''){ // Posting Date validation
                    if(DocDate!=''){ // Document Date validation
                        // <!-- ---------------- form submit process start here ----------------- -->
                            var formData = new FormData($('#inventory_transfer_form-qc-post-doc')[0]); // form Id
    ...
    $(document).on('change','#upload-File',function(){
        ...
        $.ajax({
            ...
            success: function(result)
            {
                // console.log(result);
                // var JSONObject = JSON.parse(result);
                $('#targetPath1').val(result.targetPath);
                $('#fileName1').val(result.fileName);
                $('#attachDate1').val(result.attatchment_date);
