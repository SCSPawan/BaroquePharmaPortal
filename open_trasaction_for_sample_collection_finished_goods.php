...
<?php include 'models/qc_process/sample_collection_finished_goods_model.php' ?>
    ...
    <script type="text/javascript">
        ...
        function OT_PoPup_SampleCollection_in_process(DocEntry,BatchNo,ItemCode,LineNum){
            $.ajax({ 
                ...
                success: function(result){
                    ...
                    $(`#SC_finished_good_IntimatedDate`).val(DateFormatingYMD(JSONObject[0].IntimationDate));
                    ...
                    $(`#SC_finished_good_MakeBy`).val(JSONObject[0].MakeBy);
        ...
        function getSeriesDropdown(){
            var TrDate= $('#SC_finished_good_DocDate').val();
            var dataString ='TrDate='+TrDate+'&ObjectCode=SCS_SCOLFG&action=getSeriesDropdown_ajax';
            $.ajax({
                type: "POST",
                url: 'ajax/common-ajax.php',
                data: dataString,
        ...
        function selectedSeries(){
            ...
            var dataString ='TrDate='+TrDate+'&Series='+Series+'&ObjectCode=SCS_SCOLFG&action=getSeriesSingleData_ajax';
