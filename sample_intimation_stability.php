                ...
                <div class="row" id="footerProcess">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <!-- hidden field define here start ------------------------------------------------- -->
                                    ...
                                    <div class="col-xl-9 col-md-6">
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea class="form-control" rows="4" id="SIS_ContainerNos" name="SIS_ContainerNos" readonly></textarea>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".Sample_Inti_Stability_RPT" autocomplete="off" onclick="View_RPT_Open_PUT('StabilitySAMPLEINTIUNDERTEST','Print Undertest Label');">Print Undertest Label</button>

                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".Sample_Inti_Stability_RPT" autocomplete="off" onclick="View_RPT_Open('StabilitySAMPLEINTIQUARLABEL','Print Quarantine');">Print Quarantine</button>

                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".Sample_Inti_Stability_RPT" autocomplete="off" onclick="View_RPT_Open('StabilitySAMPLEINTIMATION','Print Sample Intimation');">Print Sample Intimation</button>
                                        </div>
...
<script type="text/javascript">
    ...
    function TransToUnder(){
        ...
        var StabilityQty=document.getElementById('SIS_StabilityPlanQty').value;
        ...
        $('#SIS_ITI_Quality').val(StabilityQty);
        $('#SIS_ITI_FromWhs').val(FromWhse);
        $('#SIS_ITI_ToWhs').val(ToWhse);
        $('#SIS_ITI_Location').val(Location);
        $('#SIS_ITI_UOM').val(UOM);

        ContainerSelection() // DocName By using API to get dropdown 
    }
    ...
    function getSeriesDropdown(){
        var TrDate = $('#SIS_IT_PostingDate').val();
    ...
    function selectedSeries(){
        ...
        var TrDate = $('#SIS_IT_PostingDate').val();
        var dataString ='Series='+Series+'&TrDate='+TrDate+'&ObjectCode=67&action=getSeriesSingleData_ajax';
        $.ajax({
            type: "POST",
            url: 'ajax/common-ajax.php',
            data: dataString,
    ...
    function getSeriesDataViewMood(Series){
        ...
        var TrDate = $('#PostingDate_ViewMode').val();
        var dataString ='Series='+Series+'&TrDate='+TrDate+'&ObjectCode=67&action=getSeriesSingleData_ajax';
        $.ajax({
            type: "POST",
            url: 'ajax/common-ajax.php',
    ...
    function View_RPT_Open_PUT(API_Name,RPT_Title){
        var DocEntry=$('#SIS_UnderTestTransferNo').val();
