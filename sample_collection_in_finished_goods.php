                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content p-3 text-muted">
                                                ...
                                                <div class="tab-pane" id="home" role="tabpanel">
                                                       ...
                                                       <div class="d-flex flex-wrap gap-2">
                                                            <!-- Toggle States Button -->
                                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".inventory_transfer" >Transfer</button>
                                                ...
                                                <div class="tab-pane" id="profile" role="tabpanel">
                                                    <div class="table-responsive" id="list">
                                                        <table id="tblItemRecord" class="table sample-table-responsive table-bordered" style="">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2">
                                                                <!-- Toggle States Button -->
                                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".goods_issue">Post Extra Issue</button>
...
// console.log('totalRowCount_N=>', totalRowCount_N);
        ...
        var dataString ='DocEntry='+DocEntry+'&action=Sample_Collection_Finished_Goods_In_Process';
        $.ajax({  
            type: "POST",  
            url: 'ajax/kri_production_common_ajax.php',  
            data: dataString,  
                ...
                var JSONObjectAll = JSON.parse(result);
                  // console.log(JSONObjectAll['SampleCollDetails']);
                   ...
                   // console.log('dd=>',JSONObject);
                    ...
                    $(`#fg_IntimationDate`).val(JSONObject[0].IntimationDate);
                    ...
                    $(`#fg_DocDate`).val(JSONObject[0].DocDate);
                    ...
                    $(`#ReverseSampleIssue`).val(JSONObject[0].RevSamIssue);fg_DocDate
