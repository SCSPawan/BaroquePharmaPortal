                                             ...
                                             <div class="top_filter">
                                                ...
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group row mb-2">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input class="form-control desabled" type="date" id="FromDate" name="FromDate">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-3 col-md-6">
                                                    <div class="form-group row mb-2">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input class="form-control desabled" type="date" id="ToDate" name="ToDate">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                 ...
                                 <form role="form" class="form-horizontal" id="QcDpcumentFormfinisheGoods" method="post">
                                      <!-- <input type="text" id="qcD_DocEntry" name="qcD_DocEntry"> -->



                                    <input type="text" id="QC_P_DOC_FG_DocEntry" name="QC_P_DOC_FG_DocEntry">
                                         <input type="text" id="QC_P_DOC_FG_BranchID" name="QC_P_DOC_FG_BranchID">
                                         <input type="text" id="QC_P_DOC_FG_FromWhs" name="QC_P_DOC_FG_FromWhs">
                                         <input type="text" id="QC_P_DOC_FG_ToWhs" name="QC_P_DOC_FG_ToWhs">
                                       <input type="text" id="QC_P_DOC_FG_DocNum" name="QC_P_DOC_FG_DocNum">
                                       <input type="text" id="QC_P_DOC_FG_LocCode" name="QC_P_DOC_FG_LocCode">
                                    <input type="text" id="QC_P_DOC_FG_WOEntry" name="QC_P_DOC_FG_WOEntry">
                                     
                                     <input type="text" id="QC_P_DOC_FG_MfgDate" name="QC_P_DOC_FG_MfgDate">
                                     <input type="text" id="QC_P_DOC_FG_ExpiryDate" name="QC_P_DOC_FG_ExpiryDate">

                                     <input type="text" id="QC_P_DOC_FG_SampleIntimationNo" name="QC_P_DOC_FG_SampleIntimationNo">

                                       <input type="text" id="QC_P_DOC_FG_SampleCollectionNo" name="QC_P_DOC_FG_SampleCollectionNo">
                                    
                                    <input type="text" id="QC_P_DOC_FG_SampleQty" name="QC_P_DOC_FG_SampleQty">

                                    <input type="text" id="QC_P_DOC_FG_RetainQty" name="QC_P_DOC_FG_RetainQty">

                                    <!-- <input type="text" id="QC_P_DOC_FG_PostingDate" name="QC_P_DOC_FG_PostingDate"> -->
                                    <!-- <input type="text" id="QC_P_DOC_FG_ADate" name="QC_P_DOC_FG_ADate"> -->

                                    <input type="text" id="QC_P_DOC_FG_GateENo" name="QC_P_DOC_FG_GateENo">

                                      <input type="text" id="QC_P_DOC_FG_SpecfNo" name="QC_P_DOC_FG_SpecfNo"> 
                                       <input type="text" id="QC_P_DOC_FG_GRQty" name="QC_P_DOC_FG_GRQty"> 
                                       <input type="text" id="QC_P_DOC_FG_RelDate" name="QC_P_DOC_FG_RelDate">
                                     <input type="text" id="QC_P_DOC_FG_ReTsDt" name="QC_P_DOC_FG_ReTsDt">
                                      <input type="text" id="QC_P_DOC_FG_RMWQC" name="QC_P_DOC_FG_RMWQC">
                                 ...
                                 <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-select desabled" id="QC_P_DOC_FG_SampleType" name="QC_P_DOC_FG_SampleType">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Doc No</label>
                                                ...
                                                <div class="col-lg-4">
                                                    <select class="form-control desabled" type="text" id="QC_P_DOC_FG_DocName" name="QC_P_DOC_FG_DocName"></select>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Posting Date</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="date" id="QC_P_DOC_FG_PostingDate" name="QC_P_DOC_FG_PostingDate">
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Analysis Date</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="date" id="QC_P_DOC_FG_AnalysisDate" name="QC_P_DOC_FG_AnalysisDate">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-xl-3 col-md-6">
                                                            <div class="form-group row mb-2">
                                                                ...
                                                                <div class="col-lg-7">
                                                                    ...
                                                                    <!-- <input class="form-control" type="text" id="QC_P_DOC_FG_AssayPotency" name="QC_P_DOC_FG_AssayPotency"> -->
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3 col-md-6">
                                                            <div class="form-group row mb-2">
                                                                ...
                                                                <div class="col-lg-8">
                                                                    ...
                                                                    <!-- <input class="form-control" type="text" id="QC_P_DOC_FG_LODWater" name="QC_P_DOC_FG_LODWater"> -->
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3 col-md-6">
                                                            <div class="form-group row mb-2">
                                                                ...
                                                                <div class="col-lg-5">
                                                                    <select class="form-select" id="QC_P_DOC_FG_AssayCalc" name="QC_P_DOC_FG_AssayCalc">
                                                        ...
                                                        <div class="col-xl-3 col-md-6">
                                                            <div class="form-group row mb-2">
                                                                ...
                                                                <div class="col-lg-8">
                                                                    ...
                                                                    <!-- <input class="form-control" type="text" id="QC_P_DOC_FG_Potency" name="QC_P_DOC_FG_Potency"> -->
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <!-- -------footer button---- -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="d-flex flex-wrap gap-2">
                                                             <!-- Toggle States Button -->
                                                             <button type="button" class="btn btn-primary" id="addQcPostDocumentSubmitQCCheckFinishesGoodaBtn" name="addQcPostDocumentSubmitQCCheckFinishesGoodaBtn" onclick="return add_qc_post_document();">Add</button>
                ...
                $("#footerProcess").show();
                   ...
                   // 
                    ...
                    $(`#QC_P_DOC_FG_DocEntry`).val(JSONObject[0].DocEntry);
                     ...
                     // $(`#QC_P_DOC_FG_DocNo`).val(JSONObject[0].Series);
                     // $(`#QC_P_DOC_FG_DocName`).val(JSONObject[0].SeriesName);
                     ...
                     $(`#QC_P_DOC_FG_SampleCollectionNo`).val(JSONObject[0].SampleCollectionNo);
                      ...
                      $(`#QC_P_DOC_FG_RetainQty`).val(JSONObject[0].RetainQty);
                       // $(`#QC_P_DOC_FG_PostingDate`).val(JSONObject[0].PostingDate);
                       // $(`#QC_P_DOC_FG_ADate`).val(JSONObject[0].ADate);
...
// TableId=@SCS_SINPROCESS&Alias=PC_SType
...
function SampleTypeDropdown(){
        ...
        // var dataString ='action=dropdownMaster_ajax';
