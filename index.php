                                ...
                                <div class="p-2 mt-4">
                                    <form action="home.php">
                                        ...
                                        <div class="mt-3 text-end">
                                            <button class="btn btn-primary w-sm waves-effect waves-light" onclick="home.php" type="submit">Log In</button>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center text-muted p-4">
                            <p class="text-black-10"><b>© <script>document.write(new Date().getFullYear())</script> Design & Develop by <i class="mdi mdi-heart text-danger"></i> SoftCore Solutions Pvt. Ltd.</b></p>
                        </div>
                    </div>
                </div>
