                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-select" id="Stage" name="Stage"></select>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-pane active" id="general_data" role="tabpanel">
                                                    <div class="table-responsive qc_list_table table_item_padding" id="list">
                                                        <table id="tblItemRecord" class="table sample-table-responsive table-bordered" style="">
                                                            ...
                                                            <tbody id="retest-general-data-list-append"></tbody>
                                                        </table>
                                                    </div>
                                                    <!--end table-->
                                                ...
                                                <div class="tab-pane" id="qc_status" role="tabpanel">
                                                    <div class="table-responsive" id="list">
                                                        ...
                                                        <table id="tblItemRecord" class="table sample-table-responsive table-bordered" style="">
                                                            ...
                                                            <tbody id="retest-status-list-append"></tbody>
                                                        </table>
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="table-responsive" id="list">
                                                                <table id="tblItemRecord" class="table table-bordered" style="">
                                                                    ...
                                                                    <tbody id="retest-attach-list-append"></tbody>
                                                                </table>
                                                            </div><!--table responsive end-->
                                                        </div><!--col closed-->
            ...
            <div class="modal-body">
                ...
                <form role="form" class="form-horizontal" id="inventory_transfer_form" method="post">
                    <div class="row">
                        ...
                        <input type="hidden" id="it_SeriesId" name="it_SeriesId">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-lg-5">
                                    <select class="form-select" id="it_SeriesName" name="it_SeriesName" onchange="selectedSeries()"></select>
                                </div>
                                <div class="col-lg-3">
