        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Stability QC check
 </h5>
                                 ...
                                 <div class="row">
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                <label class="col-lg-4 col-form-label mt-6" for="val-skill">Sr.No</label>
                                                <div class="col-lg-8">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                <label class="col-lg-4 col-form-label mt-6" for="val-skill">Plant</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" id="" name="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                <label class="col-lg-4 col-form-label mt-6" for="val-skill">Sample Receive Date</label>
                                                <div class="col-lg-8">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Wrahouse</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" id="" name="">
                                                </div>
                                            </div>
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">BIN Code</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" id="" name="">
                                                </div>
                                            </div>
                                       ...
                                       <div class="col-xl-3 col-md-6">
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Stability Condition/Bin</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" id="" name="">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <tfoot class="">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <input type="text" name="FinalTotal" id="FinalTotal" value="00.00" class="FreightInput" readonly="">
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6" >
                                                                    ...
                                                                    <div class="qc_attatchment">
                                                                     ...
                                                                     <button type="button" class="btn btn-primary" data-bs-toggle="button" autocomplete="off">Label /QA Analysis Print</button>
                                                                 </div>
                                                                </div>
                                                            </div>
