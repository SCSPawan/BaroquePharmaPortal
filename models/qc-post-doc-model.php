                                        ...
                                        <div class="tab-content p-3 text-muted">
                                            ...
                                            <div class="tab-pane" id="qc_status" role="tabpanel">
                                                <div class="table-responsive" id="list2">
                                                    ...
                                                    <table id="tblItemRecord2" class="table sample-table-responsive table-bordered" style="">
                                                        <thead class="fixedHeader1">
                                                            <tr>
                                                                <th>Sr. No</th>
                                                                <!-- <th>Status</th>
                                                ...
                                                <!-- <div class="row">
                                                    <div class="col-xl-3 col-md-6">
                                                        <div class="form-group row mb-2">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <input class="form-control" type="text" id="gRpoRemainingQty" name="gRpoRemainingQty">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> -->
