            ...
            <div class="modal-body">
                ...
                <!-- <form> -->
                     <form role="form" class="form-horizontal" id="inventory_transfer_form_transfer" method="post">
                       <div class="row">
                        <input type="text" id="transfer_it_NextNumber" name="transfer_it_NextNumber">
                         ...
                         <div class="col-xl-3 col-md-6">
                            <div class="form-group row mb-2">
                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Series</label>
                                <div class="col-lg-6">
                                    <select class="form-select" id="transfer_it_DocNoName" name="transfer_it_DocNoName" onchange="selectedSeries()"></select>
                                </div>
                                <div class="col-lg-2">
                                    <input class="form-control desabled" type="text" id="transfer_it_DocNo" name="transfer_it_DocNo" readonly>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-xl-3 col-md-6">
                            <div class="form-group row mb-2">
                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Posting Date</label>
                                 <div class="col-lg-8">
                                    <input class="form-control" type="date" id="it_PostingDate_tras" name="it_PostingDate_tras">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-xl-3 col-md-6">
                            <div class="form-group row mb-2">
                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Document Date</label>
                                 <div class="col-lg-8">
                                    <input class="form-control" type="date" id="it_DocDate_trans" name="it_DocDate_trans">
                                </div>
                            </div>
                        </div>
