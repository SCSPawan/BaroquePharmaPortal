...
.FreightInput:focus {border: transparent;outline: none;}
 ...
 <!--start qc check model-->
        ...
        <div class="modal fade qc-check-inprocess" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">QC Check-InProcess </h5>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="card-body">
                                 <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                <label class="col-lg-4 col-form-label mt-6" for="val-skill">In House Id</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="text" id="" name="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Test Date
                                                </label>
                                                <div class="col-lg-8">
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Sam.Incube Date</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="date" id="" name="">
                                                </div>
                                            </div>
