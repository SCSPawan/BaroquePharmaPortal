...
<!--sample intimation model-->
    <div class="modal fade sample-intimation-in-process" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" data-bs-backdrop="static">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-select" id="TrBy" name="TrBy"></select>
                                    </div>
                                </div>
                            </div>  
