        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                ...
                <form role="form" class="form-horizontal" id="inventory_transfer_finished_good_form" method="post">
                 <input class="form-control desabled" type="hidden" id="TransferToUndertest_DocEntry" name="TransferToUndertest_DocEntry">
                 <input class="form-control desabled" type="hidden" id="TransferToUndertest_BPL_Id" name="TransferToUndertest_BPL_Id">
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Series</label>
                                                 <div class="col-lg-8">
                                                    <input class="form-control desabled" type="text" id="TransferToUndertest_Series" name="TransferToUndertest_Series" readonly>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Posting Date</label>
                                                 <div class="col-lg-8">
                                                    <input class="form-control" type="date" id="TransferToUndertest_PostingDate" name="TransferToUndertest_PostingDate">
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Document Date</label>
                                                 <div class="col-lg-8">
                                                    <input class="form-control" type="date" id="TransferToUndertest_DocumentDate" name="TransferToUndertest_DocumentDate">
                                                </div>
                                            </div>
                                        </div>
