                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-6">
                                                    <input class="form-control desabled" type="text" id="QC_CK_D_SampleIntimationNo" name="QC_CK_D_SampleIntimationNo" readonly="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-6">
                                                    <input class="form-control desabled" type="text" id="QC_CK_D_SampleCollectionNo" name="QC_CK_D_SampleCollectionNo" readonly="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-8">
                                                    <input class="form-control desabled" type="text" id="QC_CK_D_SampleQty" name="QC_CK_D_SampleQty" readonly="">
                                                </div>
                                            </div>
                                        </div>
