...
.mt-6{margin-top: -6px !important;}
    ...
    <!--start sample collection in process model-->
        <div class="modal fade sample-collection-in-process" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
        aria-hidden="true">
        ...
        <form role="form" class="form-horizontal" id="OTSCP_Form" method="post">
                                <div class="row">
                                   <input class="form-control desabled" type="text" id="IP_SC_LineNum" name="IP_SC_LineNum">
                                   <input class="form-control desabled" type="text" id="IP_SC_BPLId" name="IP_SC_BPLId">
                                   <input class="form-control desabled" type="text" id="IP_SC_BatchQty" name="IP_SC_BatchQty">
                                   <input class="form-control desabled" type="text" id="IP_SC_LocCode" name="IP_SC_LocCode">
                                   <input class="form-control desabled" type="text" id="IP_SC_RetainQtyUOM" name="IP_SC_RetainQtyUOM">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-4">
                                                    <select class="form-select" id="IP_SC_DocName" name="IP_SC_DocName">
                                                        <option></option>
                                                    </select>
                                                </div>
                                                 <div class="col-lg-4">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-7">
                                                    <select class="form-control" id="IP_SC_smpleCollectBy" name="IP_SC_mpleCollectBy"></select>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">DocDate</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control" type="date" id="IP_SC_DocDate" name="IP_SC_DocDate">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="d-flex flex-wrap gap-2 mt-2">
                              ...
                              <button type="button" class="btn btn-primary active" data-bs-toggle="button" autocomplete="off" id="SampleCollectionInProcess_Btn" name="SampleCollectionInProcess_Btn" onclick="SampleCollectionInProcess_Submit();">Add</button>
                               ...
                               <button type="button" data-bs-dismiss="modal" aria-label="Close"  class="btn btn-primary active" data-bs-toggle="button" autocomplete="off">Cancel</button>
