...
<input type="text" id="extraIssue_NextNumber" name="extraIssue_NextNumber">
<input type="text" id="extraIssue_GI_SCRTQCB_DocEntry" name="extraIssue_GI_SCRTQCB_DocEntry">
<input type="text" id="extraIssue_BPLId_samIss" name="extraIssue_BPLId_samIss">
<input type="text" id="extraIssue_supplierCode" name="extraIssue_supplierCode">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                         ...
                         <div class="col-xl-3 col-md-6">
                            <div class="form-group row mb-2">
                               ...
                               <div class="col-lg-6">
                                    <select class="form-select" id="extraIssue_DocNoName" name="extraIssue_DocNoName" onchange="selectedSeries()"></select>
                                </div>
                                <div class="col-lg-2">
                         ...
                         <div class="col-xl-3 col-md-6">
                            <div class="form-group row mb-2">
                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Posting Date</label>
                                 <div class="col-lg-8">
                                   <input class="form-control" type="date" id="extraIssue_postingDate" name="extraIssue_postingDate">
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-xl-3 col-md-6">
                            <div class="form-group row mb-2">
                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Document Date</label>
                                 <div class="col-lg-8">
                                    <input class="form-control" type="date" id="extraIssue_DocumentDate" name="extraIssue_DocumentDate">
                                </div>
                            </div>
                        </div>
                    </div><!--row end-->
