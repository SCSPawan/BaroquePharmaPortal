...
.FreightInput:focus {border: transparent;outline: none;}
 ...
 <!--start qc check model-->
        ...
        <div class="modal fade qa-approval-fg" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
        aria-hidden="true">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6" >
                                                                    ...
                                                                    <div class="qc_attatchment">
                                                                     ...
                                                                     <button type="button" class="btn btn-primary" data-bs-toggle="button" autocomplete="off">QC Analysis Print</button>
                                                                 </div>
                                                                </div>
                                                            </div>
