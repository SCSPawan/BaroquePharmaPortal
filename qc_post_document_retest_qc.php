                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <form role="form" class="form-horizontal" id="qcPostDocumentRetestForm_update" method="post">
                                      <div class="row">
                                         <input type="text" id="qcD_LineNum" name="qcD_LineNum">
                                         ...
                                         <input type="text" id="itP_FromWhs" name="itP_FromWhs">
                                         <input type="text" id="itP_ToWhs" name="itP_ToWhs">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-8">
                                                    <input class="form-control desabled" readonly type="date" id="qcD_MfgDate" name="qcD_MfgDate">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-lg-8">
                                                    <input class="form-control desabled" readonly type="date" id="qcD_ExpiryDate" name="qcD_ExpiryDate">
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Posting Date</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control desabled" readonly type="date" id="qcD_PostingDate" name="qcD_PostingDate">
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Analysis Date</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control desabled" readonly type="date" id="qcD_ADate" name="qcD_ADate">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="form-group row mb-2">
                                               <label class="col-lg-4 col-form-label mt-6" for="val-skill">Valid Up To</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control desabled" readonly type="date" id="qcD_ValidUpto" name="qcD_ValidUpto">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <!-- -------footer button---- -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="d-flex flex-wrap gap-2">
                                                             <!-- Toggle States Button -->
                                                             <button type="button" class="btn btn-primary" id="updateQcPostDocumentRetestBtn" name="updateQcPostDocumentRetestBtn" onclick="return update_qc_post_document_retest_qc();">Add</button>
...
// alert('hiii');
        ...
        $.ajax({
            ...
            data:{'DocEntry':qcD_DocEntry,'action':"qc_post_document_retest_qc_pupup_ajax"},
            cache: false,
            dataType:'JSON',
            beforeSend: function(){
                // Show image container
